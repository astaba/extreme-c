...
// Description: Implement 3d geometry conversion from polar to cartesian and
// vice versa.
...
cartesian_pos_3d_t
convert_to_3d_cartesian_pos(const polar_pos_3d_t *polar_pos) {
...
polar_pos_3d_t
convert_to_3d_polar_pos(const cartesian_pos_3d_t *cartesian_pos) {
